            ...
            <div class="card-content">
                <div class="content">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            <input type="hidden" name="gambar_lama" value="<?= $item['picture']; ?>">
                            <label class="label" for="gambar">Gambar</label>
                            <div class="control">
                                <input type="file" class="input gambar" name="gambar" onchange="previewImage()">
                            </div>
                            <img src="../assets/img/<?= $item['picture']; ?>" width="120" style="display: block;" class="img-preview">
                        </div>
